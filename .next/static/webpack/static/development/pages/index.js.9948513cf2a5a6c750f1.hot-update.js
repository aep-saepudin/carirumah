...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(ModalModalExample, [{
    ...
    value: function componentDidMount() {// this.props.history.listen = (location,action) => console.log(location)
      // window.onhashchange = () => {
      //   console.log(location.hash == '#openMap' ? true : false)
      //   this.setState({open:location.hash == '#openMap' ? true : false})
      // }
    }
  }, {
    key: "render",
...
/* harmony default export */ __webpack_exports__["default"] = (ModalModalExample);

/***/ })

})
//# sourceMappingURL=index.js.9948513cf2a5a6c750f1.hot-update.js.map